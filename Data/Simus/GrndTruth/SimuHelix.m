Imphase = (imread('~/matlab/COMCI/Data/Simus/GrndTruth/HelixNebula_Amp_Ph.tif','Index',2));
ImMod = (imread('~/matlab/COMCI/Data/Simus/GrndTruth/HelixNebula_Amp_Ph.tif','Index',1));
